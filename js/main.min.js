...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_modules_button__WEBPACK_IMPORTED_MODULE_3__["initButtons"])();
    Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_4__["initAccordions"])();
...
var initAccordions = function initAccordions() {
  ...
  for (var i = 0; i < buttons.length; i++) {
    buttons[i].addEventListener('click', function (_ref) {
      var target = _ref.target;
      var accordion = target.closest('[data-accordion]');
      var groups = accordion.querySelectorAll('[data-accordion-item]');
      var groupCurrent = target.closest('[data-accordion-item]');
...
var initButtons = function initButtons() {
  var button = document.querySelector('[data-hide-button]');
  button.addEventListener('click', function (_ref) {
    var target = _ref.target;
    var block = target.closest('[data-hide]');
    ...
    if (breakpoint && block.classList.contains('is-open')) {
      var text = block.querySelector('span');
      text.classList.remove('hidden-mobile');
    } else {
      var _text = block.querySelector('span');
      _text.classList.add('hidden-mobile');
    }
  });
};
